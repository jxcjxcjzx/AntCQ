...
*/
 function enter(){
	...
	console.log(" entering dbAnt , welcome ...  ");
 }
 ...
 var _broadcastList = ["discoverAnt"];
...
function tmp_test(){
 ...
 function broadcastActions(actions){
 ...
 function log(content){
	// console .log and then log it into log file 
	console.log(content);
 }
 

var small_bunches_of_commands = {

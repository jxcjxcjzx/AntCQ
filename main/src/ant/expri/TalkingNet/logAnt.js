...
var Constants = {
	...
	logFileName : "ant_log_"+this._time+".txt",
...
*/
 function enter(){
	...
	console.log(" entering logAnt , welcome ...  ");
 }
...
function tmp_test(){
 ...
 function addLog(_data){
	// first the time and form the logFileName

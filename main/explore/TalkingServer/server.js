...
http.createServer(function(req,res){
	...
	if(req.method === 'POST'){
		...
		req.addListener("end",function(){
			...
			var _postDataAfterHandle = postDataHandle.obtain(postData);
			postDataHandle.getWriteStream().write(_postDataAfterHandle);
			postDataHandle.popDetails(handler.getHandler());
			// one more thing 
			/*  handle();   has moved to pop_Details  */
...
console.log('Server running at http://you know the ip:1999/?testit');